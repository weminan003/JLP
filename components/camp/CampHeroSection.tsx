...
export const CampHeroSection = () => {
  return (
    <section
      ...
      className="relative flex min-h-[100dvh] flex-col bg-white pb-24 md:pb-32 lg:pb-40"
    >
      <div className="flex flex-1 flex-col items-center justify-end px-6 pb-10 pt-28 text-center md:pb-14 md:pt-32">
        <div className="relative mx-auto w-full max-w-3xl">
          <h1 className="camp-hero-enter camp-hero-enter--1 text-balance text-[clamp(2.25rem,6.5vw,4.5rem)] font-bold leading-[1.03] tracking-[-0.03em] text-neutral-950">
            Supernatural Teens Recharge Camp 2026
          </h1>
          <p className="camp-hero-enter camp-hero-enter--2 mx-auto mt-4 max-w-xl text-pretty text-[clamp(1rem,2vw,1.125rem)] leading-relaxed text-neutral-500">
            Five days of encounter with God to ignite passion, awaken purpose, and
            transform your future.
          </p>
          <div className="camp-hero-enter camp-hero-enter--3 mt-5 flex flex-wrap items-center justify-center gap-3">
      ...
      <div className="relative mx-auto flex max-w-4xl shrink-0 items-end justify-center overflow-visible px-4">
        {GALLERY_IMAGES.map((image, index) => (
          <div
            key={image.src}
            className={`camp-hero-enter ${image.enterClass} relative h-[160px] w-[110px] shrink-0 overflow-hidden rounded-2xl shadow-[0_16px_40px_rgba(0,0,0,0.12)] transition-transform duration-500 hover:z-50 hover:scale-[1.04] sm:h-[200px] sm:w-[140px] md:h-[240px] md:w-[170px] ${image.className}`}
            style={{ marginLeft: index === 0 ? 0 : "-2.5rem" }}
          >
            <Image
              src={image.src}
              alt={image.alt}
